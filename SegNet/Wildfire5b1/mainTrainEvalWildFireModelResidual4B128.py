...
from datasetAugmentationWildFire5B  import WildFireDataset
...
parse.add_argument(
    '--mode', choices=['train', 'eval', 'valid', 'test', 'eval_diff'], default='train')
parse.add_argument('--batch_size', '-b', type=int, default=256)
...
model = WildFireNet(5, nb_classe, dims=dim) #numero de canales

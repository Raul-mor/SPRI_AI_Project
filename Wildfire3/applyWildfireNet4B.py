...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', 
        default=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                            "Wildfire3_N__128__AUG_1_valid_best_3264.pth"))
    ...
    MEAN = [0.15265982818134405, 0.12155882904556131, 0.11179684095377862, 0.2149179913310541]
    STD = [0.06175473860122212, 0.04970513459616255, 0.04281088892387709, 0.09208002357648823]
